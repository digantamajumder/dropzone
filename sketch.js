...
function setup() {
	...
	rect1 = createSprite(width/2,645,400,30);
	rect1.shapeColor = color(255,0,0);
	rect2 = createSprite(200,600,40,120);
	rect2.shapeColor = color(255,0,0);
	rect3 = createSprite(600,600,40,120);
	...
	rect1Body= Bodies.rectangle(400,645,400,30,{isStatic:true});
